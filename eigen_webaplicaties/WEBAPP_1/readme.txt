maak van een python script een webapplicatie. Hierbij moet de in webpagina links de invoer van naam en adres gedaan kunnen worden. Deze gegevens worden opgeslagen in tabel INVOER.
In dezelfde html web pagina moet aan de rechterkant van het scherm de output getoond worden. Dit moet om de 2 seconden gedaan worden. De query van de output is alles van tabel INVOER
Dat betekent dus dat als je een invoer doet je deze binnen 2 seconden op hetzelfde scherm ziet verschijnen aan de rechterkant.
